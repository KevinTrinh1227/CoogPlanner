// app/my-degree/MyDegreeClient.tsx
    ...
    <div className="flex flex-col gap-14">
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm text-slate-300">
          Download your{" "}
          <span className="font-semibold">unofficial transcript</span> from
          myUH/PeopleSoft, then upload the PDF here. We&apos;ll eventually parse
          it to detect completed and in-progress courses. You can fix anything
      ...
      <section className="space-y-5">
        ...
        <p className="text-sm text-slate-300">
          Once your courses and degree info look right, run an analysis to see
          how your classes line up with your requirements and where the gaps
          might be. Later, this will also suggest concrete next-semester
          options.
        </p>
