          ...
          <div className="mt-3 flex items-center justify-center">
            <div className="flex w-full max-w-xs gap-2">
              <Link
                href="/login"
                prefetch={false}
                className="flex flex-1 items-center justify-center rounded-md border border-slate-700 bg-slate-950 px-4 py-2.5 text-sm font-semibold text-slate-100 shadow-sm transition-colors hover:border-slate-500 hover:bg-slate-900"
                onClick={closeAll}
              >
                Sign in
              </Link>
              <Link
                href="/signup"
                prefetch={false}
                className="flex flex-1 items-center justify-center rounded-md bg-red-400 px-4 py-2.5 text-sm font-semibold text-slate-950 shadow-sm transition-colors hover:bg-red-300"
                onClick={closeAll}
              >
                Sign up
              </Link>
